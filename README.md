...
4. summary_graph_month.R erstellt eine monatliche Zusammenfassung und postet diese.

Die Scripts 1. bis 3. werden nacheinander von einem cronjob ausgeführt mit genug Pause (30 min) zwischen den Ausführungen.
Script 4. wird an jedem Monatsersten ausgeführt (ebenfalls über cronjob).
